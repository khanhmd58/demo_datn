...
path_conf = '/home/khanhmd/Desktop/neuron_attention/'
...
def run_main():
  ...
  parser.add_argument(
      "--input_graph",
      type=str,
      default=path_conf+"logdir_inference/graph.pbtxt",
  ...
  parser.add_argument(
      "--input_checkpoint",
      type=str,
      default=path_conf+"logdir/model_epoch_20_gs_160",
  ...
  parser.add_argument(
      "--output_graph",
      type=str,
      default=path_conf+"model/frozen_graph.pb",
  ...
  parser.add_argument(
      "--output_node_names",
      type=str,
      default='Placeholder,Placeholder_1,ToInt32',
